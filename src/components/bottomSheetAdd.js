    ...
    return (
        <Portal>
            <Animated.View style={[styles.root, {height:bottomSheetAddHeight,bottom:bottom,shadowOffset:{
                height:-3
            }},styles.common,{flexDirection:'column'}]}   onPressOut={onDismiss} >
                ...
                <Menu style={{}} size='large'>
                    <MenuItem  title='Take photo'  accessoryLeft={PhotoIcon}/>
                    <MenuItem title='Add image' accessoryLeft={ImageIcon} />
                    <MenuItem title='Checklists' accessoryLeft={checkIcon}/>
                    <MenuItem title='Recording' accessoryLeft={RecordingIcon}/>
                </Menu>
